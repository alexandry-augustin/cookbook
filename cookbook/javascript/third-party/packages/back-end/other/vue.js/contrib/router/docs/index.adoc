...
include::./sections/route_variable.adoc[leveloffset=+1]

include::./sections/example.adoc[leveloffset=+1]

include::./sections/static_routes.adoc[leveloffset=+1]

include::./sections/dynamic_routes.adoc[leveloffset=+1]

include::./sections/nested_routes.adoc[leveloffset=+1]

include::./sections/redirection.adoc[leveloffset=+1]

include::./sections/scroll_behaviour.adoc[leveloffset=+1]
